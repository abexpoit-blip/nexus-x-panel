...
export const SystemHealthWidget = () => {
  ...
  const { server, database, seven1tel_bot, xisora_bot, counts } = data;
  ...
  const anyBotUp = !!(seven1tel_bot?.running || xisora_bot?.running);
  ...
  return (
    <div className="glass-card border border-white/[0.06] rounded-xl p-5 space-y-4">
      ...
      <div className="grid grid-cols-1 gap-2.5">
        ...
        <BotCard name="XISORA bot"    snap={xisora_bot} />
      </div>
